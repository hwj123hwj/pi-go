...
export const en = {
  ...
  'kb.issues': 'issues',
  'kb.all': 'All',
  'kb.allGood': 'Knowledge base is healthy!',
  'kb.empty': 'Knowledge base is empty',
  'kb.noResults': 'No matching entries',
  'kb.noTags': 'No tags yet',
  'kb.loadFailed': 'Failed to load',
  'kb.searchPlaceholder': 'Search knowledge base…',
  'kb.missingMeta': 'Missing Metadata',
  'kb.missingTitle': 'Missing title',
  'kb.missingSummary': 'Missing summary',
  'kb.missingTags': 'Missing tags',
  'kb.duplicates': 'Duplicates',
  'kb.tagClusters': 'Tag Inconsistencies',
