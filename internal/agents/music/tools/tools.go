...
func BaseToolNames() []string {
	return []string{"music_search", "music_play", "music_lyrics", "music_detail", "music_playlist", "music_recommend", "music_history"}
}
